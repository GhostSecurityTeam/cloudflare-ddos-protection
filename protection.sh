...
###
# Automating your CloudFlare DDoS Protection by https://ghostsecurityteam.io/ - Developed by UniDoX
###
...
function ddos_check(){
    ...
    then
        ...
        then
            ...
            if [[ $notifications == 1 ]] ; then
                echo "$(date) - Disabled DDoS"  | mail -s "Enabled DDoS" UniDoX@ghostsecurityteam.io
            fi
        else
        exit 0
        fi
